...
function M.new( instance )
    ...
    -- our character
    local sheetOptionsIdleCowBoy = require("assets.spritesheets.cowBoy.cowBoyIdle")
    local sheetIdleCowBoy = graphics.newImageSheet( "./assets/spritesheets/cowBoy/cowBoyIdle.png", sheetOptionsIdleCowBoy:getSheet() )

    local sheetOptionsRunCowBoy = require("assets.spritesheets.cowBoy.cowBoyRun")
    local sheetRunningCowBoy = graphics.newImageSheet( "./assets/spritesheets/cowBoy/cowBoyRun.png", sheetOptionsRunCowBoy:getSheet() )
    ...
    local sequence_data = {
        ...
        },
        {
            ...
            time = 1000,
            loopCount = 0,
            sheet = sheetRunningCowBoy
        }
    }

    instance = display.newSprite( parent, sheetIdleCowBoy, sequence_data )
